/**
 * LEGACY — ver scripts/legacy/README.md
 * No usar en producción. El build usa scripts/fetch-logos.mjs
 */
...
console.log(`Generated ${Object.keys(LOTTERIES).length} lottery logos (legacy placeholders)`);
